...
F1_5 = 2.175    # frost protection/subgrade interface (sensor 2.5cm below interface)
F1_4 = 2.4      # 25.0cm into subgrade
F1_3 = 2.625    # 47.5cm into subgrade
F1_2 = 3.15     # 100.0cm into subgrade
F1_1 = 3.85     # 170.0cm into subgrade
...
F2_3 = 2.175    # frost protection/subgrade interface (sensor 2.5cm below interface)
F2_2 = 2.4      # 25.0cm into subgrade
F2_1 = 2.625    # 47.5cm into subgrade
...
F3_3 = 2.175    # frost protection/subgrade interface (sensor 2.5cm below interface)
F3_2 = 2.4      # 25.0cm into subgrade
F3_1 = 2.625    # 47.5cm into subgrade
...
F4_3 = 2.175    # frost protection/subgrade interface (sensor 2.5cm below interface)
F4_2 = 2.4      # 25.0cm into subgrade
F4_1 = 2.625    # 47.5cm into subgrade
...
F5_5 = 1.05     # subbase/frost protection interface
F5_4 = 1.6      # mid frost protection
F5_3 = 2.175    # frost protection/subgrade interface (sensor 2.5cm below interface)
F5_2 = 2.4      # 25.0cm into subgrade
F5_1 = 2.625    # 47.5cm into subgrade
...
F6_7 = 1.05     # subbase/expanded clay interface
F6_6 = 1.20     # mid expanded clay
F6_5 = 1.35     # expanded clay/frost protection interface
F6_4 = 1.75     # mid frost protection
F6_3 = 2.175    # frost protection/subgrade interface (sensor 2.5cm below interface)
F6_2 = 2.4      # 25.0cm into subgrade
F6_1 = 2.625    # 47.5cm into subgrade
F6_sensor_loc = [F6_10, F6_9, F6_8, F6_7, F6_6, F6_5, F6_4, F6_3, F6_2, F6_1]

# Section F7 - crushed rock 22/180
...
F7_5 = 2.175    # frost protection/subgrade interface (sensor 2.5cm below interface)
F7_4 = 2.4      # 25.0cm into subgrade
F7_3 = 2.625    # 47.5cm into subgrade
F7_2 = 3.15     # 100.0cm into subgrade
F7_1 = 3.85     # 170.0cm into subgrade
...
F1_int4 = 2.15  # frost protection/subgrade interface
F1_interface = [F1_int1, F1_int2, F1_int3, F1_int4]

# Section F2 - XPS
F2_int1 = 0.00  # top of asphalt
F2_int2 = 0.25  # asphalt/subbase interface
F2_int3 = 1.05  # subbase/0/16mm interface
F2_int4 = 1.35  # 0/16mm/xps interface
F2_int5 = 1.40  # xps/0/16mm interface
F2_int6 = 1.50  # 0/16mm/frost protection interface
F2_int7 = 2.15  # frost protection/subgrade interface
F2_interface = [F2_int1, F2_int2, F2_int3, F2_int4, F2_int5, F2_int6, F2_int7]

# Section F3 - 0/180
F3_int1 = 0.00  # top of asphalt
F3_int2 = 0.25  # asphalt/subbase interface
F3_int3 = 1.05  # subbase/frost protection interface
F3_int4 = 2.15  # frost protection/subgrade interface
F3_interface = [F3_int1, F3_int2, F3_int3, F3_int4]

# Section F4 - foam glass
F4_int1 = 0.00  # top of asphalt
F4_int2 = 0.25  # asphalt/subbase interface
F4_int3 = 1.05  # subbase/foam glass interface
F4_int4 = 1.35  # foam glass/frost protection interface
F4_int5 = 2.15  # frost protection/subgrade interface
F4_interface = [F4_int1, F4_int2, F4_int3, F4_int4, F4_int5]

# Section F5 - 0/32
F5_int1 = 0.00  # top of asphalt
F5_int2 = 0.25  # asphalt/subbase interface
F5_int3 = 1.05  # subbase/frost protection interface
F5_int4 = 2.15  # frost protection/subgrade interface
F5_interface = [F5_int1, F5_int2, F5_int3, F5_int4]

# Section F6 - expanded clay
F6_int1 = 0.00  # top of asphalt
F6_int2 = 0.25  # asphalt/subbase interface
F6_int3 = 1.05  # subbase/expanded clay interface
F6_int4 = 1.35  # expanded clay/frost protection interface
F6_int5 = 2.15  # frost protection/subgrade interface
F6_interface = [F6_int1, F6_int2, F6_int3, F6_int4, F6_int5]

# F7 - crushed rock 22/180
# Section F5 - 0/32
F7_int1 = 0.00  # top of asphalt
F7_int2 = 0.25  # asphalt/subbase interface
F7_int3 = 1.05  # subbase/frost protection interface
...
class SectionParametersE6:
    def __init__(self):
        self.section_F1 = {'section_name': 'F1 - unsorted gravel',
                           ...
                           'layer_names': [['asphalt:', '250mm'],
                                           ['subbase:', '250mm'],
                                           ['unsorted gravel:', '1100mm'],
                                           ['subgrade']]}
